  ...
  "inline-flex items-center justify-center whitespace-nowrap rounded-md text-sm font-medium ring-offset-white transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-zinc-950 focus-visible:ring-offset-2",
  {
    variants: {
      variant: {
        ...
        tertiary:
          "text-orange-500 bg-[#ffff] hover:bg-orange-50 border border-[#e6e6e6] hover:text-orange-500 disabled:bg-neutral-50 disabled:text-neutral-100 active:bg-orange-100 active:text-orange-700 focus:bg-neutral-50 focus:text-blue-500 focus:border-blue-300 focus:border-[2px]",
        ghost:
